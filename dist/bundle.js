...
define("components/project-list", ["require", "exports", "state/project-state", "decorators/autobind", "components/base-component", "models/project", "components/project-item"], function (require, exports, project_state_1, autobind_js_2, base_component_js_2, project_js_2, project_item_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ProjectList extends base_component_js_2.Component {
        ...
        dropHandler(event) {
            ...
            project_state_1.projectState.moveProject(prjId, this.type === "active" ? project_js_2.ProjectStatus.Active : project_js_2.ProjectStatus.Finished);
        }
...
define("components/project-input", ["require", "exports", "components/base-component", "utils/validation", "decorators/autobind", "state/project-state"], function (require, exports, base_component_js_3, validation_js_1, autobind_js_3, project_state_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
